...
print ('\nAfter the image creation is done use the next command to unmount the NFS share and delete mount directory:')
print (f'sudo umount {NFSv4Path} && sudo rmdir {NFSv4Path}')
## To clear console
